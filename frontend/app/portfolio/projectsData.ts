...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    gradient: "linear-gradient(135deg, #2b1f07 0%, #594210 50%, #1a1304 100%)",
    initials: "SR",
  ...
  },
  {
    ...
    category: "Social Media",
    gradient: "linear-gradient(135deg, #0e2a47 0%, #1b4975 50%, #0a1c30 100%)",
    initials: "FC",
  ...
  },
  {
    ...
    category: "Branding",
    gradient: "linear-gradient(135deg, #0f3818 0%, #1b5e2b 50%, #0a2410 100%)",
    initials: "SV",
  ...
  },
  {
    ...
    category: "Branding",
    gradient: "linear-gradient(135deg, #0e1d33 0%, #1b3861 50%, #091321 100%)",
    initials: "KP",
  ...
  },
  {
    ...
    industry: "B2B SaaS",
    category: "SEO & Ads",
    gradient: "linear-gradient(135deg, #4d2600 0%, #994d00 50%, #331a00 100%)",
    initials: "TN",
  ...
  },
  {
    ...
    industry: "Beauty & D2C",
    category: "Branding",
    gradient: "linear-gradient(135deg, #4d1000 0%, #992100 50%, #290b00 100%)",
    initials: "GB",
