...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '185 100 50', // Cyan default for BotMate theme
  backgroundColor = '#04080F', // Dark cyber background default
  borderRadius = 24,
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  colors = ['#00e5ff', '#3b82f6', '#8b5cf6'], // Cyan, Electric Blue, Purple
  fillOpacity = 0.5,
  style,
}) => {
